...
setup(
    ...
    url='https://github.com/Osmose/firefox-cert-override',
    ...
    keywords='firefox certificate security',
    ...
    entry_points={
        'console_scripts': [
            'firefox-cert-override=firefox_cert_override.cli:generate',
        ],
    },
)
